...
_instance2.default.activate = function (stateParams) {
  return (0, _registrar2.default)(stateParams).then(_canceler2.default).then(_initializer2.default).then((0, _eventer2.default)('started')).then(_canceler2.default).then(_preprocessor2.default).then(_canceler2.default).then(_resolver2.default).then(_canceler2.default).then((0, _eventer2.default)('loading')).then(_deactivator2.default).then(_canceler2.default).then(_renderer2.default).then(_canceler2.default).then(_connector2.default).then(_canceler2.default).then(_displayer2.default).then((0, _eventer2.default)('loaded')).then(_canceler2.default).then(_finalizer2.default).then((0, _eventer2.default)('entered')).catch(_lodash2.default.partial(_errorer2.default, _lodash2.default, stateParams));
};