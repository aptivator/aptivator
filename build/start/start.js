...
_instance2.default.start = function () {
  return (0, _queueChecker2.default)().then(_rootViewBuilder2.default).then(_invalidRouteHandler2.default).then(_starter2.default).catch(_error2.default.errorer);
};